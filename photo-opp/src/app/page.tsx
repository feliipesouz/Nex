...
export default function HomePage() {
  return (
    <main className="h-screen w-full flex flex-col justify-between bg-background items-center bg-gradient-to-br from-backgroundGradientStart to-backgroundGradientEnd p-8">
