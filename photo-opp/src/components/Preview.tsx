...
export default function Preview({ imageUrl, onRetake, onApprove }: Props) {
    return (
        <div className="h-screen w-full bg-black flex flex-col items-center justify-center gap-6 p-6">
            ...
            <div className="flex gap-20 md:justify-center md:w-full items-center justify-between">
                <button
                    onClick={onRetake}
                    className="bg-zinc-600 text-white text-lg font-semibold px-6 py-3 rounded hover:bg-zinc-500"
                >
                    Refazer
                </button>
                <button
